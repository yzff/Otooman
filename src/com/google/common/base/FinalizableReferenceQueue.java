...
public class FinalizableReferenceQueue {
    ...
    static {
        Class<?> finalizer =
            loadFinalizer(new SystemLoader(), new DecoupledLoader(),
                new DirectLoader());
    ...
    public FinalizableReferenceQueue() {
        ...
        try {
            queue =
                (ReferenceQueue<Object>) startFinalizer.invoke(null,
    ...
    static class DecoupledLoader implements FinalizerLoader {
        ...
        public Class<?> loadFinalizer() {
            try {
                 ...
                 * loader
                 * implementation in the JDK. If we used our own ClassLoader
                 * subclass,
                ...
                ClassLoader finalizerLoader = new URLClassLoader(new URL[] {
                    base
                });
        ...
        URL getBaseUrl() {
            ...
            String finalizerPath =
                FINALIZER_CLASS_NAME.replace('.', '/') + ".class";
            URL finalizerUrl =
                getClass().getClassLoader().getResource(finalizerPath);
