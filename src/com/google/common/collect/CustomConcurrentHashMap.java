 ...
 * return new InternalEntry&lt;K, V&gt;(key, original.hash, original.value,
 * next);
 * }
...
final class CustomConcurrentHashMap {
    ...
    public interface Strategy<K, V, E> {
         ...
         *            inopportune time in implementations that don't otherwise
         *            keep
    ...
    static class Impl<K, V, E> extends AbstractMap<K, V> implements
        ...
        final class Segment extends ReentrantLock {
            ...
            void expand() {
                ...
                Strategy<K, V, E> s = Impl.this.strategy;
                AtomicReferenceArray<E> newTable =
                ...
                for (int oldIndex = 0; oldIndex < oldCapacity; oldIndex++) {
                    ...
                    if (head != null) {
                        ...
                        if (next == null) {
                            ...
                            for (E last = next; last != null; last =
                                s.getNext(last)) {
                ...
                try {
                    ...
                    for (E e = first; e != null; e = s.getNext(e)) {
                        if (s.getHash(e) == hash && entry.equals(e)) {
                            V entryValue = s.getValue(e);
                            if (entryValue == value
                                || (value != null && s.equalValues(entryValue,
                                    value))) {
                                // All entries following removed node can stay
                                // in list, but all preceding ones need to be
                                // cloned.
        ...
        abstract class HashIterator {
            ...
            boolean nextInChain() {
                Strategy<K, V, E> s = Impl.this.strategy;
                if (nextEntry != null) {
                    for (nextEntry = s.getNext(nextEntry); nextEntry != null; nextEntry =
                        s.getNext(nextEntry)) {
        ...
        private void readObject(java.io.ObjectInputStream in)
            ...
            try {
                ...
                Strategy<K, V, E> strategy =
                    (Strategy<K, V, E>) in.readObject();
                ...
                if (entry == null) {
                    ...
                    try {
                        ...
                        if (entry == null) {
                            ...
                            ++segment.modCount;
                            entry =
                                computingStrategy.newEntry(key, hash, first);
                    ...
                    if (created) {
                        ...
                        try {
                            V value =
                                computingStrategy.compute(key, entry, computer);
                            if (value == null) {
                                throw new NullPointerException(
